...
ZzzServer = function(options) {
     ...
     */
    httpServer._addRoute = function(method, route, callback, scope) {
    ...
    methods.forEach(function(method) {
        ...
        httpServer[method] = function(route, callback, scope) {

            httpServer._addRoute(method.toUpperCase(), route, callback, scope);
        }
